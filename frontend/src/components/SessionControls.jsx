...
function SessionControls({ user, onStartSession, onStopSession, sessionActive, wsConnected, runtimeReady }) {
  ...
  return (
    <div className="glass-card rounded-xl p-6">
      ...
      <div className="mb-6 p-3 rounded-lg glass-panel">
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-gray-300">Python Runtime:</span>
          <div className="flex items-center space-x-2">
            <div className={`w-2 h-2 rounded-full ${runtimeReady ? 'bg-green-500' : 'bg-amber-500'}`} />
            <span className={`text-sm font-semibold ${runtimeReady ? 'text-green-400' : 'text-amber-400'}`}>
              {runtimeReady ? 'Online' : 'Offline'}
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              disabled={!wsConnected || !runtimeReady}
            />
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-400">
              Browser playback mirrors adaptive sound levels from the neurofeedback loop
            </p>
          </div>
          ...
          <button
            ...
            disabled={!wsConnected || !runtimeReady || loading}
          ...
          {wsConnected && !runtimeReady && (
            <p className="text-sm text-amber-400 text-center">
              Python runtime is offline. Start python_eeg_pipeline to enable session controls.
            </p>
          )}
        </div>
      ) : (
